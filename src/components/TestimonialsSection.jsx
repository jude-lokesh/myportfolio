  ...
  const Testimonials = [
    {
      ...
      name: "John",
      picture: "/pic.jpg",
      text: "sample ata dkjsdso sdlksfd s;djl kj s d;",
    },
    {
      id: 1,
      name: "John",
      ...
      <div className="grid gap-8 grid-cols-1 md:grid-cols-2 xl:grid-cols-3 mt-20">
        {Testimonials.map(({ id, name, image, text }) => (
          <motion.div
            ...
            viewport={{ once: true, amount: 0.8 }}
            key={id}
            className="border-2 border-green-500 backdrop-blur-sm bg-white/30 p-8 rounded-3xl text-white"
          >
            <div className="flex items-center  mb-9 text-amber-500">
              <svg
                className="w-5 h-5"
                viewBox="0 0 18 17"
                fill="none"
